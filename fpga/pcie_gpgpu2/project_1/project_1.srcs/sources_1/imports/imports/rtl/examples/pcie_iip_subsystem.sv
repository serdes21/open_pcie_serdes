...
//(* mark_debug="true", keep="true" *) wire          ctrl_rst_n_dbg        = ctrl_rst_n;
//(* mark_debug="true", keep="true" *) wire          app_ltssm_enable_dbg  = app_ltssm_enable;
//(* mark_debug="true", keep="true" *) wire  [5:0]   smlh_ltssm_state_dbg  = smlh_ltssm_state;  // 6-bit
//(* mark_debug="true", keep="true" *) wire          rdlh_link_up_dbg      = rdlh_link_up;
//(* mark_debug="true", keep="true" *) wire          smlh_link_up_dbg      = smlh_link_up;
//(* mark_debug="true", keep="true" *) wire          link_req_rst_not_dbg  = link_req_rst_not;
//(* mark_debug="true", keep="true" *) wire          smlh_req_rst_not_dbg  = smlh_req_rst_not;
//(* mark_debug="true", keep="true" *) wire [63:0]   cxpl_debug_info_dbg   = cxpl_debug_info;   // 64-bit
////
////// ============================================================
////// ② ILA-1 实例 -- 把原来连到 ILA 的信号全部换成 *_dbg
////// ============================================================
//(* mark_debug="true", keep="true" *)
//ila_1 u_ila_pclk (
//    .clk    (pclk),                 // 125 MHz
//    .probe0 (ctrl_rst_n_dbg     ),  // 0
//    .probe1 (app_ltssm_enable_dbg), // 1
//    .probe2 (smlh_ltssm_state_dbg), // 7:2  (6 bit)
//    .probe3 (rdlh_link_up_dbg   ),  // 8
//    .probe4 (smlh_link_up_dbg   ),  // 9
//    .probe5 (link_req_rst_not_dbg), // 10
//    .probe6 (smlh_req_rst_not_dbg), // 11
//    .probe7 (cxpl_debug_info_dbg)   // 12  (64 bit)
//);
